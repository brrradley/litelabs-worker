...
ENV LITELABS_RESEARCH_BUILD=model-ground-truth-bakeoff-1
...
RUN test -f /app/benchmark_suite.py && test -f /app/ground_truth_benchmark.py && test -f /app/model_ground_truth_bakeoff.py && python -c "import sys; sys.path.insert(0, '/app'); import benchmark_suite, ground_truth_benchmark, model_ground_truth_bakeoff; print('research benchmark modules import ok')"
