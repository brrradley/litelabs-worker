...
ENV LITELABS_RESEARCH_BUILD=ground-truth-batch-2
...
RUN test -f /app/benchmark_suite.py && test -f /app/ground_truth_benchmark.py && python -c "import sys; sys.path.insert(0, '/app'); import benchmark_suite, ground_truth_benchmark; print('research benchmark modules import ok')"
